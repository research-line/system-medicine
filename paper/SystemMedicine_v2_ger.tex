...
\begin{itemize}
    ...
    \item \textbf{Vergleich}: CRR gegenüber standardmäßiger HPO-only-Filterung auf dem gleichen Fallsatz.
\end{itemize}
...
Der Quellcode des Prototyps, einschließlich Datenbankschema, Aufnahmepipelines, Ausschluss-Engines und GUI-Anwendung, ist im \href{https://github.com/um-bruch/system-medicine}{öffentlichen GitHub-Repository} verfügbar. Das System integriert ausschließlich öffentliche Datenquellen; es werden keine Patientendaten verwendet oder benötigt.

% ================================================================
\section*{KI-Nutzungserklärung}
